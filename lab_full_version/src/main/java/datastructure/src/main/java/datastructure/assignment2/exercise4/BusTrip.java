...
public class BusTrip {
    ...
    public BusTrip(String busNumber, String departLocation, LocalTime departTime,
                   String arrivalLocation, LocalTime arrivalTime, float cost) {
    ...
    public boolean equals(Object o) {
        if (o instanceof BusTrip) {
            ...
            return busNumber.equals(s.busNumber) &&
                    departLocation.equals(s.departLocation)
