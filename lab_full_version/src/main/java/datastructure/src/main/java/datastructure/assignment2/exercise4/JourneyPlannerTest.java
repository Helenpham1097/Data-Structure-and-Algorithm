...
public class JourneyPlannerTest {
    ...
    {   System.out.println("------ JOURNEY PLANNER -----");
        ...
        List<BusJourney> options = planner.getPossibleJourneys("Papakura",
                LocalTime.of(6, 0),
                "Gulf Harbour",
                LocalTime.of(15,0));

//        List<BusJourney> options = planner.getPossibleJourneys("New Lynn",
//                LocalTime.of(8, 30),
//                "Ponsonby",
//                LocalTime.of(10,0));

//        List<BusJourney> options = planner.getPossibleJourneys("Auckland CBD",
//                LocalTime.of(13, 0),
//                "Manukau",
//                LocalTime.of(15,0));
...
//        List<BusJourney> options = planner.getPossibleJourneys("Manukau",
//                LocalTime.of(6, 0),
//                "Ponsonby",
//                LocalTime.of(23,0));

        //YOU NEED TO WRITE a SUITABLE  "JouneyComparator"
        Collections.sort(options, new JourneyPlanner.JourneyComparator());
