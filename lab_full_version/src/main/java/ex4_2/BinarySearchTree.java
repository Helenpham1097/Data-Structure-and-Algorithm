...
//            traversalPreOrderWithoutRescursion(rootNode);
//            traversePostOrderWithoutRecursion(rootNode);
            traversalInOrderWithoutRecursion(rootNode);
...
//            traverseLevelOrder(rootNode);
        ...
        private void traversalInOrderWithoutRecursion(BinaryTreeNode startNode) {
            Stack<BinaryTreeNode> stack = new Stack<>();
            BinaryTreeNode currentNode = startNode;
            ...
            while (currentNode != null || !stack.isEmpty()) {
                ...
                BinaryTreeNode topNode = stack.pop();
                list.add(topNode.element);
        ...
        private void traversalPreOrderWithoutRescursion(BinaryTreeNode startNode) {
            Stack<BinaryTreeNode> stack = new Stack<>();
            BinaryTreeNode currentNode = startNode;
            stack.push(currentNode);
            while (!stack.isEmpty()) {
        ...
        private void traversePostOrderWithoutRecursion(BinaryTreeNode startNode) {
            Stack<BinaryTreeNode> stack = new Stack<>();
            BinaryTreeNode prev = startNode;
            BinaryTreeNode current = startNode;
            stack.push(startNode);

            while (!stack.isEmpty()) {
                current = stack.peek();
                boolean hasChild = (current.leftChild != null || current.rightChild != null);
                boolean isPrevLastChild = (prev == current.rightChild
                        || (prev == current.leftChild && current.rightChild == null));
